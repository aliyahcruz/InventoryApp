...
function productLabel(product: any) {
  ...
  function exportInventory() {
    ...
    downloadCsv(
      ...
      ["NDC", "Product", "Current", "Minimum", "Location", "Reorder"],
      rows
    );
  }
...
export default function InventoryPage() {
  ...
  const filtered = useMemo(() => {
    ...
    return matching.sort((a, b) => {
      const productA = linkedProductName(a.fields["Product"], productMap);
      const productB = linkedProductName(b.fields["Product"], productMap);
    ...
    <main className="container">
      ...
      <div className="card">
        <div className="row">
          ...
          <button type="button" className="secondary" onClick={exportInventory} disabled={filtered.length === 0}>Export CSV</button>
        </div>
      </div>
