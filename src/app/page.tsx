    ...
    <main className="container">
      ...
      {scanMode === "physical" && (
        <div className={scanFlash ? "card flash-border" : "card"}>
          ...
          <p className="small">Most USB/Bluetooth barcode scanners work like a keyboard. Click the box below, then scan the item. When the scanner sends Enter, the barcode section fills automatically.</p>
          ...
          <input
            ...
            autoFocus
          />
          <p className="small">No button is needed. After a scan, review action and quantity, then press Submit.</p>
        </div>
      )}
