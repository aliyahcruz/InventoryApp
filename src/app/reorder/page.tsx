...
function productLabel(product: any) {
  ...
  function exportReorder() {
    ...
    downloadCsv(
      ...
      ["NDC", "Product", "340B?", "ADM?", "Current", "Minimum", "Location"],
      rows
    );
  }
    ...
    <main className="container">
      ...
      <div className="card">
        <div className="row">
          ...
          <button type="button" className="secondary" onClick={exportReorder} disabled={records.length === 0}>
            Export CSV
          </button>
        </div>
      </div>
