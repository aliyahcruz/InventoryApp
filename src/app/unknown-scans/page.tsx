...
export default function UnknownScansPage() {
  ...
  return (
    <main className="container">
      ...
      <h1>Unknown Scans</h1>
      <p>
        Resolve unknown scans by correcting the NDC and selecting the matching Product. When resolved,
        the app saves the exact Raw Scan Value → Corrected NDC mapping. Future scans of that same barcode
        will use the saved NDC automatically before the normal NDC extraction logic runs.
      </p>
      ...
      {records.map((r) => {
        ...
        return (
          <div className="card" key={r.id}>
            ...
            {r.fields["Notes"] && <p><strong>Scan Notes:</strong> {r.fields["Notes"]}</p>}

            <label>Corrected NDC</label>
            ...
            <button
              ...
              disabled={isResolving || !form.productId || !form.resolvedBy || !String(ndc).replace(/\D/g, "")}
            >
